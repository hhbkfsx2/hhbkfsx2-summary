...
\include{1jahr_sections/1jahr_1lfa_gott}
%\include{1jahr_sections/1jahr_1lfb_gott}
%\include{1jahr_sections/1jahr_2lf_waec}
%\include{1jahr_sections/1jahr_4lf_dig.tech}
%\include{1jahr_sections/1jahr_4lf_oeni.waec}
%\include{1jahr_sections/1jahr_4lf_wieg}
%\include{1jahr_sections/1jahr_4lf_wiss}
%\include{1jahr_sections/1jahr_5lf_waec}
%\include{1jahr_sections/1jahr_6lf_abu}
%\include{1jahr_sections/1jahr_6lf_dres}
